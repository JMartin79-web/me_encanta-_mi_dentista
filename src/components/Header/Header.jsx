  ...
  <div className={toggle ? 'dashboard-container' : 'dashboard-container-close'}>
    ...
    <div className='dashboard-content'>
        <div className='dashboard-links'>
              <HashLink className='link' onClick={handleToggle} smooth to="/#inicio">Inicio</HashLink>
              <HashLink className='link' onClick={handleToggle} smooth to="/#nosotros">Nosotros</HashLink>
              <HashLink className='link' onClick={handleToggle} smooth to="/#contacto">contacto</HashLink >
          </div>
          ...
          <div className='dashboard-icons'>
            ...
            <a className='header-icon-link' href='https://www.facebook.com/meencantamidentista1' target='_blank' rel="noreferrer">
            ...
            <a className='header-icon-link' href='https://www.instagram.com/meencantamidentista/?hl=es-la' target='_blank' rel="noreferrer">
